...
PROJECT="HCP_Staging"
DESTINATION_ROOT="/home/shared/NRG/hcp_shared/FreeSurferHiresCodeChanges2"
...
for subject in ${subject_list} ; do
	...
	from_dir=${DATABASE_ARCHIVE_ROOT}/${PROJECT}/arc001/${subject}_3T/RESOURCES/Structural_preproc_test_Pipelines_dev
